...
<body>
    ...
    <div class="container">
        <a class="navbar-brand" href=".">Jenna's Studio</a>
        <button
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 text-dark">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="admin.php?page=profile">Profile Elenanda</a></li>
    ...
    <div>Elenanda Steavanus Yosawabi &copy; 2023</div>
    </footer>
    <!-- footer end -->
    <script
